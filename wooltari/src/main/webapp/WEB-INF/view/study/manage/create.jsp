...
<script type="text/javascript"
	src="<%=cp%>/resource/js/jquery.1.11.1.js"></script>

<script type="text/javascript"
	src="<%=cp%>/resource/js/bootstrap.min.js"></script>
...
input[name=style]:checked+label, input[name=isTestLesson]:checked+label,
	...
	input[name=target2]:checked+label, #what {
			...
			<div class="swiper-slide">
				...
				<div class="section-area">
							...
							<div class="upload-label">
								<div class="fileBox">
									...
									<label for="uploadBtn" class="btn btn-large uploadLabel "
										style="left: 120px; top: 104px; position: absolute;border-radius: 0px;">사진올리기</label>
								</div>
					...
					<div class="section-question">
						...
						<div class="question-answer">
							<textarea class="form-control" rows="10%" cols="80%" style="border-radius: 0px;"
								name="study_Info" id="study_Info" placeholder="40자 이내로 입력해주세요."
								onchange="study_InfoCheck();"></textarea>
						</div>
					</div>
				</div>
					...
					<div class="section-question">
						...
						<div class="question-answer">
							<div class="row targetWrap">
								...
								</select> <select name="smallCategory" id="smallCategory"
									class="selectField" style="width: 45%;">
									<option value="">:: 중분류 ::</option>
								</select>
							</div>
							<div id="select_category" style="">
								<div>
									<div
										style="width: 536px; height: 40px; margin: 0 auto; background-color: #1abc9c;">
										<div
											style="display: inline-block; font-size: 20px; line-height: 40px; color: white;">
											안녕</div>
										<div style=" float: right;">
											<img alt="" src="<%=cp%>/resource/img/delete.png"
												width="20px" height="20px" onclick="" style="margin: 10px 7px; cursor: pointer;">
					...
					<div class="section-question">
						...
						<div class="question-answer">
							<div class="row targetWrap">
								...
								</select> <select name="smallCity" id="smallCity" class="selectField"
									style="width: 45%;">
									<option value="">:: 중분류 ::</option>
								</select>
				...
				<div class="section-area">
					...
					<div class="section-question">
						...
						<label for="uploadBtn2" class="btn btn-large uploadLabel">스터디
							만들기</label> <input type="button" id="uploadBtn2" class="uploadBtn tts">
