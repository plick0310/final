	...
	<thead>
		<tr>
			<th class="informations">
				<span style="font-size: 25px;">	${dto.subject }</span>
				<br><br>
				<span class="inforArea" style="font-size: 15px; margin-bottom: -37px;">
	...
	<tbody>
		...
		<tr>
			<td style="width: 270px; font-size: 15px; font-weight: bold;">
				카테고리>${dto.name }<br><br>
				지역>${dto.cityName }<br><br>
				스터디정원>${dto.recruit }명<br><br>
				모집대상>${dto.target }
				<img src="<%=cp%>/uploads/photo/${dto.imageFileName}" style="max-width: 400px; height: 160px; margin-top:-130px; resize: both; float: right;" onerror="this.src='<%=cp%>/resource/images/reviewPhoto/promote.PNG'">
			</td>
		...
		<tr>		
			<td class="read_contArea">
				...
				<div id="board_memo_area" style="min-height: 200px; font-size: 20px;">
					${dto.content}
				</div>
		...
		<hr style="width: 1000px; margin-bottom: -75px;" >
