...
<div style="width: 900px; height: 600px; margin: 60px auto;">
	<div style="height: 50px; font-size: 20px; text-align: center;">
		...
		<span style="font-size: 9px; color: #6799FF;">&nbsp;&nbsp;(최대 '5'개까지 등록 가능합니다)</span>
	...
	<form name="array_form" id="array_form" style="width: 900px; border-top: 1px solid #4b4b4b;">
		...
		<c:if test="${empty examwishList }">
			...
			<div style="text-align: center; width: 870px;" class="col-sm-6">
				<span style="color:#BDBDBD; letter-spacing: 2px;">등록한 시험 목록이 없습니다. <strong style="color: #1abc9c;">추가버튼</strong>을 눌러주세요 </span>
			</div>
			<div class="col-sm-6" style="text-align: right; width: 20px;">
				<button id="modalbtn" type="button" onclick="create()"
					class="glyphicon glyphicon-plus"></button>
			</div>
			</div>		
...
<form name="mockSearchForm" action="" method="post">
	<input type="hidden" name="searchKey" value="subject"> <input
			...
			<form name="modalForm" method="post" enctype="multipart/form-data">
				...
				<div class="modal-footer">
					<button type="button" class="clickbtn"
						onclick="createOk('${mode}');">${mode=='update'?'수정완료':'등록하기' }</button>
