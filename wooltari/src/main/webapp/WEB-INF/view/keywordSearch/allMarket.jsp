...
<div style="margin: auto; width: 57%;">
	<div style="padding-top: 20px; font-size: 17px; ">
		<table class="tab_menu" style="width:100%; float: left; display: block; text-align: left; border-top: 1px solid #f1f3f6; border-bottom: 1px solid #e2e2e2; ">
			<tr>
				...
				<td style="height:50px; line-height:50px; margin-left:30px; float: left; position: relative; list-style-type: none; font-family: 'BareunDotum',gulim,helvetica,sans-serif; border-bottom:2px solid #1abc9c;"><a style="cursor: pointer; color: #1abc9c;" onclick="location.href='<%=cp%>/keyword/marketSearch?keyword=${keyword }'">스터디마켓</a></td>
	...
	<div style="clear: both; font-size: 16px; font-family:'BareunDotum'; font-weight: bolder; color: black; margin-bottom: 20px; margin-top: 79px;">스터디마켓[검색결과:${dataCount }개]</div>
