...
<div style="margin: auto; width: 900px;">
	...
	<div style="clear: both; font-size: 16px; font-family:'BareunDotum'; font-weight: bolder; color: black; margin-bottom: 20px; margin-top: 79px;">스터디[검색결과:${studyCount }개]</div>
