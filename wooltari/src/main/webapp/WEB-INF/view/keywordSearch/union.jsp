...
<div style="margin-left: 400px; margin-right: 600px;">
	<div>
		<ul style="float: left; display: block; text-align: left;">
			<li style="float: left; position: relative; list-style-type: none; font-family: '굴림',gulim,helvetica,sans-serif">통합검색</li>
			<li style="float: left; position: relative; list-style-type: none; font-family: '굴림',gulim,helvetica,sans-serif">스터디</li>
			<li style="float: left; position: relative; list-style-type: none; font-family: '굴림',gulim,helvetica,sans-serif">홍보</li>
		</ul>
	</div>
