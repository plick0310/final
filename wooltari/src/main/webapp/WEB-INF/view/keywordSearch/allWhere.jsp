...
<div style="margin: auto; width: 57%;">
	<div style="padding-top: 20px; font-size: 17px; ">
		<table class="tab_menu" style="width:100%; float: left; display: block; text-align: left; border-top: 1px solid #f1f3f6; border-bottom: 1px solid #e2e2e2; ">
			<tr>
				...
				<td style="height:50px; line-height:50px; border-bottom:2px solid #1abc9c;  margin-left:30px; float: left; position: relative; list-style-type: none; font-family: 'BareunDotum',gulim,helvetica,sans-serif"><a style="cursor: pointer; color: #1abc9c;" onclick="location.href='<%=cp%>/keyword/whereSearch?keyword=${keyword }'">어디서하지</a></td>
	...
	<div style="clear: both; font-size: 16px; font-family:'BareunDotum'; font-weight: bolder; color: black; margin-bottom: 20px; margin-top: 79px;">어디서하지[검색결과:${dataCount }개]</div>
		...
		<ul>
						<li style="clear: both;">			
							...
							<dl style="padding-top: 3px; overflow: hidden; line-height: 19px; display: block;">
								...
								<dt style="font-size:11px; margin-top: 8px; white-space: nowrap;overflow: hidden;text-overflow: ellipsis;">[매장명:${dto.placename }][지역:${dto.region }][영업시간:${dto.ocTime }]</dt>
								<dt style="font-size:11px; margin-top: 8px; white-space: nowrap;overflow: hidden;text-overflow: ellipsis;">[주소:${dto.address }][전화번호:${dto.tel }]</dt>
								<%-- <dd>&nbsp;&nbsp;&nbsp;${dto.content }</dd> --%>
							</dl>
						</li>
					</ul>
