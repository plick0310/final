...
<div class="container">
<div class="pic-list" id="pick-container">
	<div class="pic-list-title">WOOLTARI PICK</div>
		<div class="row no-margin">
			<c:forEach begin="1" end="10" step="1">
				<div class="col-lg-3 col-md-4 col-sm-6 col-xs-6 pic-list-margin pic-list-padding">
					<a href="#">
					<div class="study-item">
						<div class="study-item-overlay">
						</div>
						<div class="header-bg" style="background-image:url(https://moccozy.blob.core.windows.net/pictures/adc93874-bd74-489c-a13e-6bf3188a54ff.jpg)">
						</div>
						...
						<div class="item-contents">
							<div class="profile-image" style="background-image:url(https://graph.facebook.com/1081345805289267/picture?type=large)">
							</div>
							<div class="user-name">
								JaeHoon Jang
							</div>
